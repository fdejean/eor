...
export function ChapterNavigation() {
    ...
    return (
        <nav className="fixed left-0 top-0 h-full max-h-screen z-50 flex flex-col justify-center pointer-events-none">
            <div className="relative flex flex-col w-8 hover:w-72 group transition-all duration-500 pointer-events-auto overflow-hidden rounded-r-xl">
                ...
                {/* Content Container - Added min-w-[280px] to keep text layout stable while clipped */}
                <div className="relative flex flex-col gap-6 pl-2 group-hover:pl-6 pr-6 min-w-[280px] max-h-screen overflow-y-auto overflow-x-hidden no-scrollbar py-4">
